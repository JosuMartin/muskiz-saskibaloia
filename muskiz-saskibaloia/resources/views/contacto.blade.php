...
<main class="min-h-[70vh] p-10 max-w-[1200px] mx-auto overscroll-y-none flex items-center justify-center">    
    ...
    <div class="flex flex-col md:flex-row gap-20 h-full">
        ...
        <div class="flex-1 bg-green-400 p-8 rounded-3xl shadow-2xl min-h-[500px] w-[1000px] flex items-center">
        ...
        <div class="flex-1 bg-orange-400 p-8 rounded-3xl shadow-2xl min-h-[300px]">
