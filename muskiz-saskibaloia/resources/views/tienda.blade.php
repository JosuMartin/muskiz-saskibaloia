...
<main class="min-h-[70vh] p-10 max-w-[1200px] mx-auto overscroll-y-none flex items-center justify-center">    
    ...
    <div class="flex flex-col md:flex-row gap-20 h-full">
            <img src="{{ asset('images/ropa1.webp') }}" class="h-50 max-w-80">
            <img src="{{ asset('images/ropa2.webp') }}" class="h-50 max-w-80">
            <img src="{{ asset('images/ropa3.webp') }}" class="h-50 max-w-80">
    </div>
    ...
    <div class="animate-vibrar flex-1 bg-[#1e90ff]/50 backdrop-blur-md p-6 rounded-xl shadow-sm min-h-[20px] mt-20">
        ...
        <p class="text-center mb-1">¡Si estas interesado en cualquiera de nuestras prendas disponibles contacta con nosotros a traves de nuestro correo electronico!</p>
            ...
            <img src="{{ asset('images/Gmail_icon.webp') }}" alt="Logo" class="h-9 w-auto">
