<header class="w-full bg-gradient-to-b from-white to-[#1e90ff] p-4 border-b border-blue-200">
    <div class="max-w-[1200px] mx-auto flex flex-col sm:flex-row items-center justify-center gap-10">
